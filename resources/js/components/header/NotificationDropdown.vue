    ...
    <div ref="root" class="relative">
        ...
        >
            <div class="flex items-center justify-between pb-3 mb-3 border-b border-gray-100 dark:border-gray-800">
                ...
                <button class="text-gray-500 dark:text-gray-400" type="button" @click="closeDropdown">
                    ...
                    >
                        ...
                        <span class="block">
                            ...
                            <span class="flex items-center gap-2 text-theme-xs text-gray-500 dark:text-gray-400">
                                <span
                                    class="rounded-full border border-gray-200 bg-white px-2 py-0.5 dark:border-gray-800 dark:bg-gray-dark"
                                >
                                    {{ notification.type }}
                                </span>
            ...
            <button
                class="mt-4 w-full rounded-lg border border-gray-200 bg-white px-4 py-2 text-sm font-medium text-gray-700 shadow-theme-xs hover:bg-gray-50 hover:text-gray-800 dark:border-gray-800 dark:bg-gray-dark dark:text-gray-400 dark:hover:bg-white/5 dark:hover:text-gray-200"
                type="button"
