        ...
        <div class="flex flex-col items-center justify-between grow xl:flex-row xl:px-6">
            ...
            >
                <button
                    ...
                    :class="{ 'bg-gray-100 dark:bg-white/[0.03]': !sidebar.state.isExpanded }"
                    aria-label="Toggle Sidebar"
                    type="button"
                    @click="sidebar.toggleExpanded()"
                >
                    <svg
                        v-show="!sidebar.state.isMobileOpen"
                        width="16"
                        height="12"
                        viewBox="0 0 16 12"
                        fill="none"
                ...
                <button
                    ...
                    :class="{ 'bg-gray-100 dark:bg-white/[0.03]': sidebar.state.isMobileOpen }"
                ...
                <Link href="/" class="xl:hidden">
                    ...
                    <img class="hidden dark:block" src="/images/logo/logo-imapmi-dark.png" alt="Logo" />
                </Link>
