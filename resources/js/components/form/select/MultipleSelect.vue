        ...
        <div ref="root" class="relative">
            ...
            >
                <div class="flex flex-1 flex-wrap items-center gap-2">
                    ...
                    >
                        <span>{{ options.find((o) => o.id === id)?.name }}</span>
                        <button
                            type="button"
                            class="ml-1 text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-300"
                            @click.stop="toggleOption(id)"
                        >
                            <svg class="fill-current" role="button" width="14" height="14" viewBox="0 0 14 14" fill="none">
                                <path
                                    fill-rule="evenodd"
                                    clip-rule="evenodd"
            ...
            >
                <div class="overflow-y-auto" style="max-height: 16rem">
                    ...
                    >
                        <span class="text-gray-800 dark:text-white/90">{{ option.name }}</span>
                    </div>
                </div>
            </div>
        </div>
