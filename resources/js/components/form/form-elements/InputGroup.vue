    ...
    <ComponentCard title="Input Group">
        ...
        <div>
            ...
            <div class="relative">
                <div class="absolute">
                    <select
                        v-model="phoneLeft.selectedCountry"
                        ...
                        @change="applyCountryCode(phoneLeft)"
                    >
        ...
        <div>
            ...
            <div class="relative">
                <div class="absolute right-0">
                    <select
                        v-model="phoneRight.selectedCountry"
                        ...
                        @change="applyCountryCode(phoneRight)"
                    >
                        <option value="US" class="text-gray-700 dark:bg-gray-900 dark:text-gray-400">US</option>
                        <option value="GB" class="text-gray-700 dark:bg-gray-900 dark:text-gray-400">GB</option>
                        <option value="CA" class="text-gray-700 dark:bg-gray-900 dark:text-gray-400">CA</option>
                ...
                <input
                    v-model="phoneRight.phoneNumber"
                    type="tel"
                    placeholder="+1 (555) 000-0000"
