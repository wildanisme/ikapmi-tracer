    ...
    <ComponentCard title="Default Inputs">
        ...
        <div>
            ...
            <div class="relative">
                ...
                >
                    <svg v-if="!showPassword" class="fill-gray-500 dark:fill-gray-400" width="20" height="20" viewBox="0 0 20 20" fill="none">
        ...
        <div>
            ...
            <DatePicker id="date_pick" name="date_pick" placeholder="Date Picker" :default-date="today" />
        </div>
